...
//   let matEngine = new THREE.MeshPhongMaterial({color:colorList.white, shading:THREE.FlatShading});
...
//   let matTailPlane = new THREE.MeshPhongMaterial({color:colorList.blue, shading:THREE.FlatShading});
...
//   let matSideWing = new THREE.MeshPhongMaterial({color:colorList.blue, shading:THREE.FlatShading});
...
//   let matPropeller = new THREE.MeshPhongMaterial({color:colorList.brown, shading:THREE.FlatShading});
...
//   let matBlade = new THREE.MeshPhongMaterial({color:colorList.brownDark, shading:THREE.FlatShading});
...
//   let wheelProtecMat = new THREE.MeshPhongMaterial({color:colorList.blue, shading:THREE.FlatShading});
//   let wheelProtecR = new THREE.Mesh(wheelProtecGeom,wheelProtecMat);
//   wheelProtecR.position.set(25,-20,25);
//   this.mesh.add(wheelProtecR);

//   let wheelTireGeom = new THREE.BoxGeometry(24,24,4);
//   let wheelTireMat = new THREE.MeshPhongMaterial({color:colorList.brownDark, shading:THREE.FlatShading});
//   let wheelTireR = new THREE.Mesh(wheelTireGeom,wheelTireMat);
//   wheelTireR.position.set(25,-28,25);

//   let wheelAxisGeom = new THREE.BoxGeometry(10,10,6);
//   let wheelAxisMat = new THREE.MeshPhongMaterial({color:colorList.brown, shading:THREE.FlatShading});
...
//   let suspensionMat = new THREE.MeshPhongMaterial({color:colorList.blue, shading:THREE.FlatShading});
