...
var Rocket = function () {
  ...
  var portal = THREE.SceneUtils.createMultiMaterialObject(portalGeo, [portalMat, portalOutlineMat]);
  portal.position.y = 2;
  ...
  var tube = THREE.SceneUtils.createMultiMaterialObject(tubeGeo, [tubeMat, tubeOutlineMat]);
  tube.position.y = 2;
  ...
  var wing = THREE.SceneUtils.createMultiMaterialObject(wingGeo, [wingMat, wingOutlineMat]);
...
function updatePlane() {
  ...
  airplane.rocketGroup.rotation.x =
    (airplane.rocketGroup.position.y - targetY) * deltaTime * game.planeRotZSensivity;
  //update rotasi api
